...
1) master: This is the version of BNW that is used on the GENENET8 server.
...
4) genenet6_final_1.3: This is the final version of BNW on the GENENET6 server. I will keep this here until the transition to GENENET8 is complete and stable.
