                            		         ...
                            		         if(bit==1)
                                		         {
                                                        ...
                                                        {     
                                                               ...
                                                               {           		   
                             		                        white_flag++;
                                                                  //changed from white_flag=1;  
                             		                        break;
                                                               }
                                                        }
                                                        if(white_flag>=network.node[i].wlist.n)
                                                        {    //!=1
                                                              white_flag_all=1;
                                                              break; 
 ...
 // strcat(line,".txt");
  ...
  {      
          if(network.node[i].score[j]<1.0)
            fwrite(&network.node[i].score[j],sizeof(double),1,inputFiles[i]); 
// fprintf(inputFiles[i],"%lf\n",network.node[i].score[j]);
          else 
            fwrite(&min_score,sizeof(double),1,inputFiles[i]); 
//fprintf(inputFiles[i],"%lf\n",min_score);
  }  
